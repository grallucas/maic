body(
    ...
    body(
        h1("MAIC Research"),
        h3("""Our research groups are the <span style = 'font-weight: bold; color: yellow;'>best opportunity</span> we offer students for getting <span style = 'font-weight: bold; color: rgb(var(--hl-2));'>hands-on experience with developing AI technologies</span>.<br>
            """),
        div("""
        ...
        """, style = 'padding-bottom: 25px; color: gray;'),
