                ...
                div(
                    ...
                    elems(
                        div(
                            ...
                            p(entry['summary']),
                            style="margin-bottom: 15px; background-image: url(https://maic-fastapi-lambda.s3.amazonaws.com/img/misc/NN_background_pattern_2.png); background-size: cover; border-radius: 30px; border-style: solid; border-width: 3px; border-color: gray; padding-bottom: 10px; padding-right: 5%; padding-left: 5%;"
                        )
                        for entry in sorted(
